...
class AssetLocation(models.Model):
    ...
    criticality_reason = models.CharField(max_length=100, default='NA')
    GisID = models.CharField(max_length=100, default='NA')
    Connected_to_Location_ID = models.CharField(max_length=100, default='NA')
    Water_Asset_Category = models.CharField(max_length=100, default='NA')
    Land_Asset_Status = models.CharField(max_length=100, default='NA')
    Land_Ownership_Number = models.CharField(max_length=100, default='NA')
    Take_Over_Date = models.DateField()
    Take_Over_Date_Source_QT11 = models.DateField()
    Take_Over_Date_Source_CCC = models.DateField()
    Land_Area_Acre = models.CharField(max_length=100, default='NA')
    Plan_Certified_Number = models.CharField(max_length=100, default='NA')
    Plan_Pre_Computation_Number = models.CharField(max_length=100, default='NA')
    Plan_As_Built_Number = models.CharField(max_length=100, default='NA')
    Quit_Rent_Bill_Number = models.CharField(max_length=100, default='NA')
    Current_Rate_of_Quit_Rent = models.CharField(max_length=100, default='NA')
    Quit_Rent_Bill_Payment_Date = models.DateField()
    Assessment_Bill_Number = models.CharField(max_length=100, default='NA')
    Current_Rate_Of_Assesment = models.CharField(max_length=100, default='NA')
    Assessment_Bill_Payment_Date = models.CharField(max_length=100, default='NA')
    Lease_Expired_Date = models.DateField()
